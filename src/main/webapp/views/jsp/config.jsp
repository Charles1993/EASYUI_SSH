...
<body>
	...
	<table id='dg'class="easyui-datagrid" title="程序配置记录表" style="width:100%;"
			data-options="fit:true,fitColumns:true,rownumbers:true,singleSelect:true,url:'${pageContext.request.contextPath}/config/getProcedureConfigs?',method:'get',toolbar:toolbar">
		<thead>
			<tr>
				<th data-options="field:'id',width:20,align:'center'">序列</th>
	 ...
	 <div id="dlg" class="easyui-dialog" title="阿里云服务器信息配置添加" data-options="iconCls:'icon-save',closed:true" style="width:550px;height:350px;padding:10px">
		<form id="ff" method="post" style="margin-bottom:10px">
